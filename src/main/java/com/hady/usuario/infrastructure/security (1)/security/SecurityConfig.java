package com.hady.usuario.infrastructure.security;
...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(com.hady.usuario.infrastructure.security.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        com.hady.usuario.infrastructure.security.JwtRequestFilter jwtRequestFilter = new com.hady.usuario.infrastructure.security.JwtRequestFilter(jwtUtil, userDetailsService);
